...
public class ODIN {
	...
	/*
	 * Returns the ODIN-1 String for the Android device. For devices that have a
	 * null or invalid ANDROID_ID (such as the emulator), a null value will be
	 * returned.
	 * 
	 * This code is designed to be built against an Android API level 3 or
	 * greater, but supports all Android API levels.
	 * 
